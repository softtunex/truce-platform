        ...
        <div className="animate-marquee-infinite hover:[animation-play-state:paused]">
          {partnerList.map((partner, index) => (
            <div
              ...
              className="mx-2 md:mx-8 flex-shrink-0 transition-all duration-500 opacity-80 hover:opacity-100 hover:scale-110 cursor-pointer group/logo"
            >
              <img
                src={partner.logo}
                alt={partner.name}
                className="h-10 md:h-12 w-auto object-contain filter drop-shadow-sm transition-all"
              />
